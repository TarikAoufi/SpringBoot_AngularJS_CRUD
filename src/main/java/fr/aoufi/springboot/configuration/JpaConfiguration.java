package fr.aoufi.springboot.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "fr.aoufi.springboot.dao",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "fr.aoufi.springboot.model" });
